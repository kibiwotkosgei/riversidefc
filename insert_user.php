...
$check_email = mysqli_query($db_connection, "SELECT `user_email` FROM `riversideusers` WHERE user_email = '$user_email'");
...
$insert_user = mysqli_query($db_connection, "INSERT INTO `riversideusers` (username, user_email, user_password) VALUES ('$username', '$user_email', '$user_hash_password')");
